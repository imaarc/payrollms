	...
	<form action="" id="employee-attendance">
		<div class="row form-group">
			<div class="col-md-12">
				...
				<select id="employee_id" class="browser-default select2" style="width: 100%;">
				    <option value=""></option>
				    <?php 
				    ...
				    ?>
				        <option value="<?php echo $row['id'] ?>">
				            <?php echo $row['ename'] . ' | '. $row['employee_no'] ?>
				        </option>
				    <?php endwhile; ?>
				</select>
			</div>
			...
			<div class="col-md-4">
				...
				?>
				<input type="text" id="adate" class="form-control datetimepicker" autocomplete="off" placeholder="<?php echo $currentDate; ?>">
